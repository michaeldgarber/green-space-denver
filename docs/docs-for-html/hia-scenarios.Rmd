...
We estimated the number of premature deaths that would be prevented by the implementation of various policy scenarios adding green space, including native vegetation, to the City of Denver. As part of this analysis, we will estimate premature deaths that would be prevented in disproportionately impacted communities. These policy scenarios were informed by conversations with local stakeholders in advocacy, research, and governance.
