...
```{r,  eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
setwd(here("data-processed"))
load("hia_all_by_ndvi.RData")
load("hia_all_by_ndvi_s.RData") #bootstrapped version with 95% CI
...
hia_all_by_ndvi_est_boot = hia_all_by_ndvi %>% 
    left_join(hia_all_by_ndvi_s, by = c("scenario", "scenario_sub", "ndvi_native_threshold")) 
