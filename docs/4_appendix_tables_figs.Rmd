...
~green-space-denver/docs/hia-results.Rmd
...
### Restricting to 30% of the study area, prioritizing block groups of greatest need according to two health-equity definitions
...
### Restricting to 20% of the study area, prioritizing block groups of greatest need according to two health-equity definitions
...
### Scenario 4.1. Large stormwater retention ponds
...
### Scenario 4.2. Green streets

Not yet complete.

### Scenario 4.3. Site new or re-development storwmater controls
...
Finally, we propose replacing a portion of parking-lot surface with native plants. Denver's area is about 9% parking lot (below table). We obtained spatial data on [parking lots](%5Bhttps://www.denvergov.org/opendata/dataset/parking-lots-2016)](<https://www.denvergov.org/opendata/dataset/parking-lots-2016>)) from the City of Denver Open Data Catalog.
