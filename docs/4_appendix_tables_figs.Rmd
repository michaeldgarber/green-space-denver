...
The purpose of this is to output tables and figures for the appendix. Eventually, this could be rendered as a Word Doc or PDF for an appendix corresponding to a submitted manuscript. For now, it's simpler to keep as an html.
...
Chi-square comparing tertiles of CDPHE Equity Index vs City of Denver Equity Index
...
### Scenario 3.1. Large stormwater retention ponds
