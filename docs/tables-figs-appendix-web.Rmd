...
#Rwevise Feb 6 2023 to use colorblind-friendly color palette
setwd(here("data-processed"))
...
mv_den_co_osm_water = den_co_osm_water %>% 
  ...
  mapview(
    layer.name = "Water type",
    col.regions = viridis::turbo(n_distinct(den_co_osm_water$water_type)),
    zcol = "water_type")
...
# Stratified analyses by equity indices
