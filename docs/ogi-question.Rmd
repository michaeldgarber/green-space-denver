...
source code here: https://github.com/michaeldgarber/green-space-denver/blob/main/docs/ogi-question.Rmd
...
ogi_reg_proj  = st_read(dsn ="from-office-green-infra") %>%
  ...
  mutate(
    #Per CB, short-term priority projects likely to be built:
...
List of project IDs in the data
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
...
It looks like just two of the five projects coded as short-term are appearing.
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
ogi_reg_proj %>% 
