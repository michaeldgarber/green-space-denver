...
The purpose of this is to output tables and figures for the appendix. Eventually, this could be rendered as a Word Doc or PDF for an appendix corresponding to a submitted manuscript. 

As another note, this may duplicate some of the information presented in the main text. That is, the tables/figures presented in the main text can be viewed as a subset as those presented here.
