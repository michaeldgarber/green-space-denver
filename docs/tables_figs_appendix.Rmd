...
This document conatains supplementary material, mostly tables and figures, as well as some additional text and description. Eventually, this could be rendered as a Word Doc or PDF for an appendix corresponding to a submitted manuscript. 
...
These tables are an expanded version of the main-text tables, including a few more scenario possibilities.
...
# Tables: summarize over native-plants NDVI definition
