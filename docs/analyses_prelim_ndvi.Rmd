...
```{r ndvitracts2021-05-25, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.width=10}
setwd(here("data-processed"))
...
```{r ndvitracts2021-07-04, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.width=10}
den_metro_tracts_ndvi_day_wrangle_geo %>% 
...
Here is a histogram of the distribution of median NDVI on May 5:
```{r ndvitractshisto2021-05-25, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.width=10}
